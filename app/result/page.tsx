...
// ❌ HAPUS IMPORT SUPABASE (Sudah tidak dipakai di sini untuk keamanan)
// import { supabase } from '@/lib/supabase'; <-- HAPUS BARIS INI
  ...
  const processAllPhotos = async (frame: Frame, photos: string[], currentSessionId: string) => {
    try {
        ...
        finalComposite = await logger.monitorOperation(
          ...
          async () => {
            return await createPhotoStripWithFrame(
              ...
              frame.frame_config || undefined  // NEW: Pass frameConfig for double_strip support
            );
          },
      ...
      try {
        ...
        // 🔒 UPDATE SECURITY PHASE 2:
        // Kode insert manual ke tabel 'photos' SUDAH DIHAPUS dari sini.
        // Sekarang Backend (/api/sessions) yang menangani insert ke Live Feed secara otomatis.
        // Ini mencegah celah keamanan Client-side Insert.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            >
              ...
              <div
                className={`py-3 px-4 rounded-xl border flex items-center justify-center gap-3 transition-all duration-500 ${status === 'complete' ? 'bg-green-500/10 border-green-500/30 text-green-500' :
